...
# Пояснення для моделі. Самі назви рубрик надто скупі: модель домислює їхній
# сенс і на неоднозначних листах вагається між прогонами. Найдорожча
# неоднозначність — галузеві розсилки: за темою вони схожі на work, за формою
# на marketing, а насправді це worldnews.
CATEGORY_HINTS = {
    "security": "вхід у акаунт, скидання пароля, 2FA, витік даних, підозріла активність",
    "finance": "рахунки, чеки, списання, банк, податкова, продовження підписок",
    "logistics": "замовлення, доставка, бронювання, квитки, поїздки — усе з датою й номером",
    "work": "робоче листування з людьми, задачі, рев'ю, зустрічі, нотифікації "
            "робочих систем (Jira, GitHub, календар)",
    "business": "клієнти, партнери, комерційні пропозиції, договори",
    "education": "курси, лекції, навчальні матеріали, дедлайни навчання",
    "personal": "листування з живими людьми поза роботою",
    "worldnews": "новини й ДАЙДЖЕСТИ ДЛЯ ЧИТАННЯ: галузеві та IT-розсилки "
                 "(DOU, Habr, TechCrunch, тематичні newsletter'и), навіть якщо "
                 "тема виглядає робочою. Ознака — це стрічка новин, а не лист "
                 "особисто тобі й без потрібної дії",
    "marketing": "акції, промо, знижки, ретеншн-розсилки — реклама, а не новини",
    "other": "усе, що не лягло: автоматичні нотифікації сервісів, чеки з магазинів. "
...
{chr(10).join(f"  {name} — {hint}" for name, hint in CATEGORY_HINTS.items())}
